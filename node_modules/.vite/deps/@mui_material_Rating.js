...
function IconContainer(props) {
  ...
  return (0, import_jsx_runtime4.jsx)("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  if (readOnly) {
    return (0, import_jsx_runtime4.jsx)("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return (0, import_jsx_runtime5.jsxs)(React4.Fragment, {
    children: [(0, import_jsx_runtime5.jsxs)(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
...
var Rating = React4.forwardRef(function Rating2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsxs)(RatingRoot, _extends({
    ref: handleRef,
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime4.jsx)(RatingDecimal, {
          ...
          children: items.map(($, indexDecimal) => {
            ...
            return (0, import_jsx_runtime4.jsx)(RatingItem, _extends({}, ratingItemProps, {
